...
> **_NOTE:_** Quarkus now ships with a Dev UI, which is available in dev mode only at <http://localhost:5173/q/dev/>.
...
You can then execute your native executable with: `./target/linktalk-1.0.0-SNAPSHOT-runner`
